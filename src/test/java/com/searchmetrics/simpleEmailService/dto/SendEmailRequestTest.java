...
//        SendEmailRequest.setConfig(config);
    ...
    public void testConstructorAndGetters() {
        Optional<List<SendEmailRequest.Attachment>> attachments = Optional.empty();

        SendEmailRequest emailRequest = new SendEmailRequest(EMAIL_LIST, "This is a subject",
                "This is the message body. Hello!", attachments);


        Assert.assertEquals(EMAIL_LIST, emailRequest.getToEmailList());
        Assert.assertEquals("This is a subject", emailRequest.getSubject());
        Assert.assertEquals("This is the message body. Hello!", emailRequest.getMessageBody());
        Assert.assertEquals(attachments, emailRequest.getAttachmentList());
    ...
    public void testMultipleAttachments() {
        ...
        Optional<List<SendEmailRequest.Attachment>> attachments = Optional.of(attachmentList);
        ...
        // this will output the raw email
        emailRequest.toAWSRawEmailRequest();
    }
}
